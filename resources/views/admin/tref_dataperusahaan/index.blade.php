                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 50px;">
                        ...
                        <div class="pull-right" style="margin-bottom: 0px;" >
                            {!! Form::open(array('url'=>'tref_dataperusahaan/search')) !!}
                            <div class="input-group" style="width: 355px;">
                                ...
                                <div class="input-group-btn">
                                    ...
                                    <a href="{{ url('tref_dataperusahaan/create') }}" class="btn btn-sm btn-default" style="margin-right: 5px;"><i class="fa fa-plus"></i></a>
                                    <a href="{{ url('tref_dataperusahaan/create') }}" class="btn btn-sm btn-default"><i class="fa fa-print"></i></a>
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php $no=1;?>
                            @foreach($tref_dataperusahaan as $n)
                                <tr>
                                    ...
                                    <td width="30">
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <!-- View -->
                                                <li>{!! link_to('tref_dataperusahaan/'.$n->id,' View',['class'=>' fa fa-search']) !!}</li>
                                                <li>{!! link_to('tref_dataperusahaan/'.$n->id.'/edit',' Edit',['class'=>' fa fa-pencil']) !!}</li>

                                                <li role="separator" class="divider"></li>
                                                {!! Form::open(array('method'=>'delete', 'onsubmit' => 'ConfirmDelete()', 'url'=>'tref_dataperusahaan/'.$n->id)) !!}
